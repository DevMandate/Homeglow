    ...
    <section id="about" className="scroll-mt-20 bg-sky-50 py-20">
      <div className="container mx-auto px-4 flex flex-col-reverse lg:flex-row items-stretch gap-12">
        ...
        <div className="flex-1 flex flex-col justify-center space-y-6 text-center lg:text-left">
          ...
          <p className="text-gray-700 text-lg md:text-base leading-relaxed text-justify">
          ...
          <p className="text-gray-700 text-lg md:text-base leading-relaxed text-justify mt-4">
